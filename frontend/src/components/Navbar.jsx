  ...
  return (
    <div className="fixed flex flex-col items-center w-20 h-screen gap-4 p-4 duration-150 bg-gray-50 z-50 xs:p-2 xs:w-15 xs:gap-2">
      <div className="flex flex-row items-center justify-between h-10 p-2">
        ...
        <p className="hidden">uni-lectives</p>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" aria-hidden="true" className="hidden">
      ...
      <div className="flex flex-col h-full w-full justify-between border-t-2 border-gray-200">
        <div className="flex flex-col gap-3 py-3 items-center">
          <a className="flex" href="/">
            ...
            <span className="hidden">Browse Courses</span>
          </a>
          <a className="flex" href="/terms-and-conditions">
            <div className="group relative inline-block">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" aria-hidden="true" className="w-12 h-12 p-3 hover:bg-slate-200 rounded-xl">
            ...
            <span className="hidden">Terms and Conditions</span>
          </a>
        </div>
        <div className="flex flex-col gap-4 py-2 items-center">
          ...
          <div className="group relative inline-block">
            <button className="flex flex-row items-center justify-center rounded-xl gap-2 hover:bg-slate-200">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" aria-hidden="true" className="w-12 h-12 rotate-180 p-3">
          ...
          <div className="flex flex-col gap-3 max-h-20">
            <span className="hidden">
              By using this site, you agree to the <a href="/terms-and-conditions" className="inline text-blue-500 hover:underline">terms and conditions</a>.
            </span>
            <span className="hidden">
